...
CKEDITOR.dialog.add( 'recordrtcDialog', function( editor ) {
	return {
		title: 'RecordRTC Button',
		minWidth: 400,
		minHeight: 200,
		contents: [
			{
		...
		onShow: function() {
			...
			if ( !element || !element.hasClass('recordrtc-button-plugin') ) {
				element = editor.document.createElement( 'a' );
				element.setAttribute('class', 'recordrtc-button-plugin');
